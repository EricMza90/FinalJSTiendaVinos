      ...
      contenido += `
        <tbody >
          <tr>
            ...
            <img src="image/quitar.png" alt="cart" class="btn-eliminar" title="Quitar" width="22"></img>
          ...
          <td id="${vino.id}" class="text-center container-agregar" width="30"><a href="" class="btn">
            <img src="image/agregar.png" alt="cart" class="btn-sumar"  title="Agregar"width="22"></img>
            <span class="badge bg-secondary"></span>
          </a></td>
            ...
            <img id="${vino.id}" src="image/tacho.png" alt="cart" class="btn-eliminar container-eliminar" title="Eliminar Articulo" width="18"></img>
            <span class="badge bg-secondary"></span>
          </a></td>
          </tr>
        </tbody>`;
